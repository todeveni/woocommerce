...
#body_content table tbody tr:last-child td {
	border-bottom: 1px solid #ccc;
	border-bottom: 1px solid rgba(0, 0, 0, .2);
	padding-bottom: 24px;
}

#body_content table tfoot tr:first-child td,
#body_content table tfoot tr:first-child th {
	padding-top: 24px;
}
...
#body_content .order-totals-total th {
	font-weight: bold;
}

#body_content .order-totals-total td {
	font-weight: bold;
	font-size: 20px;
}

#body_content .order-totals-last td,
#body_content .order-totals-last th {
	border-bottom: 1px solid #ccc;
	border-bottom: 1px solid rgba(0, 0, 0, .2);
	padding-bottom: 24px;
}
...
img {
	...
	vertical-align: middle;
	margin-<?php echo is_rtl() ? 'left' : 'right'; ?>: 24px;
	max-width: 100%;
}
